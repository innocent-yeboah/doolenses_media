        ...
        return (
          ...
          >
            ...
            <div className={reversed ? "lg:order-1" : undefined}>
              ...
              <h2 className="font-display text-3xl font-bold text-white md:text-4xl">{service.name}</h2>
              <p className="mt-4 text-base leading-relaxed text-brand-slate">{service.description}</p>

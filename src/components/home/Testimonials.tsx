    ...
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <SectionHeading
          ...
          description="Families, organisers, and brands who chose Doolenses for their defining moments."
        />
        <div className="mt-14 grid gap-8 md:grid-cols-3">
          {TESTIMONIALS.map((item) => (
            <blockquote key={item.name} className="border border-white/10 bg-brand-navy/40 p-6">

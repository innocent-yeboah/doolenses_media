...
export function ServicesPreview() {
  ...
  return (
    <section className="bg-brand-black px-6 py-24 text-brand-white md:px-8 md:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <div
          className="relative z-20 mt-14 flex gap-1 overflow-visible border-b border-white/15"
          role="menubar"
        ...
        >
          ...
          <div className="motion-safe:animate-fade-up">
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/55">{active.shortDescription}</p>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              <Button href={getServiceHref(active.slug)} variant="outline">
                View Works
              </Button>

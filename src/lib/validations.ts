...
export const quoteStep3Schema = z.object({
  productionNeeds: z
    .array(z.string())
    .min(1, "Select at least one production need"),
...
export const portfolioInquireSchema = z.object({
...
export type PortfolioInquireValues = z.infer<typeof portfolioInquireSchema>;

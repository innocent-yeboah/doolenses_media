export const COMPANY = {
  ...
  heroHeadline: "We craft bold ideas & visuals that truly work",
  heroTrust:
    "From the first sketch to the final pixel, we shape brands that feel unmistakable — design, photography, video, web, print, and fashion from Accra.",
  aboutBlurb:

    ...
    <>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-5">
          <div className="space-y-8 lg:col-span-2">
            <div>
              <h2 className="font-display text-2xl font-bold text-brand-ink">Get in touch</h2>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li>
                <a href={`tel:${COMPANY.officePhone}`} className="flex gap-3 hover:text-brand-gold">
                  ...
                  <span>
                    <span className="block text-xs uppercase tracking-wider text-brand-body">Office</span>
              ...
              <li>
                <a href={`tel:${COMPANY.phone}`} className="flex gap-3 hover:text-brand-gold">
                  <Phone className="h-5 w-5 shrink-0 text-brand-gold" aria-hidden />
                  <span>
                    <span className="block text-xs uppercase tracking-wider text-brand-body">Mobile</span>
            ...
            <div>
              <h3 className="flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.2em] text-brand-ink">
                <Clock className="h-4 w-4 text-brand-gold" aria-hidden />
                Business hours
              </h3>
              <ul className="mt-3 space-y-1 text-sm text-brand-body">
            ...
            <a
              ...
              className="inline-flex items-center justify-center bg-[#25D366] px-5 py-3 text-sm font-semibold text-brand-ink transition hover:bg-[#1ebe57]"
            >
              Chat on WhatsApp
            </a>
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-ink">Follow us</h3>
          ...
          <div className="border border-black/10 bg-brand-mist p-6 sm:p-8 lg:col-span-3">
      ...
      <section className="px-4 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">Find us</h2>

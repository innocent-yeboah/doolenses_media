...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="border-y border-white/10 bg-brand-black px-4 py-14 sm:px-6 sm:py-20 md:px-8 md:py-24">
        <div className="mx-auto grid max-w-6xl gap-6 sm:gap-8 md:grid-cols-2">
          <div className="border border-white/15 p-6 sm:p-8">
            <h3 className="font-display text-xl font-bold text-brand-gold sm:text-2xl">Mission</h3>
          ...
          <div className="border border-white/15 p-6 sm:p-8">
            <h3 className="font-display text-xl font-bold text-brand-gold sm:text-2xl">Vision</h3>
            <p className="mt-4 text-sm leading-relaxed text-white/70 sm:text-base">
      ...
      <section className="bg-brand-black px-4 py-14 sm:px-6 sm:py-20 md:px-8 md:py-24">
      ...
      <section className="border-t border-white/10 bg-brand-black px-4 py-14 sm:px-6 sm:py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            eyebrow="The crew"
            title="Meet the Team"
          ...
          <div className="mt-12 text-center sm:mt-14">
            <Button href="/contact" size="lg" className="w-full max-w-xs sm:w-auto">
              Work With Us
            </Button>
          </div>
        </div>

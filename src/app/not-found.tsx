...
export default function NotFound() {
  return (
    <section className="flex min-h-[70vh] items-center justify-center px-4 py-28 text-center">
      <div className="max-w-lg">
        ...
        <p className="mt-4 text-brand-slate">
          That page isn&apos;t in our shot list. Head home or request a quote for your next
          production.
        </p>
